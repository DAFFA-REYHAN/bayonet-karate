...
<body>
    ...
    <div class="container">
      <div class="row g-5 align-items-center">
        <div class="col-lg-7 col-md-12 ">
          ...
          <p class="mb-4 animated bounceInDown "> "Keberanian sejati tidak ditemukan dalam pukulan keras, tetapi dalam
            keteguhan hati menghadapi rintangan. Pahlawan adalah mereka yang tetap tegar di tengah badai."</p>
          <a href="register.php"
            class="btn btn-danger border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft">Gabung Sekarang
            !</a>
    ...
    <div class="container">
      <div class="row g-5 align-items-center">
        ...
        <div class="col-lg-7 wow bounceInUp" data-wow-delay="0.3s">
          ...
          <p class="mb-3 fw-bolder text-dark text-justify ">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
            Vitae, rem quod ipsa quae asperiores Lorem ipsum dolor, sit amet consectetur adipisicing elit. Explicabo
            maxime. </p>
          <p class="mb-5 text-justify">Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore eit
          ...
          <h6 class="text-primary d-flex justify-content-between ">(Pemilik Bayonet Karate Club)
            <span class="d-flex justify-content-between"> <a href="#" class="btn btn-sm btn-outline-primary">Baca
                Selengkapnya</a></span>
          </h6>
          ...
          <div class="col-lg-5 wow bounceInUp" data-wow-delay="0.1s">
            <div class="video">
              <button type="button" class="btn btn-play" data-bs-toggle="modal"
                data-src="https://www.youtube.com/embed/8bRBtJ_wqvI?si=gaR88BRHuHT0pK6D " data-bs-target="#videoModal">
                <span></span>
              </button>
            </div>
          </div>
          ...
          <div class="modal-body">
            ...
            <div class="ratio ratio-16x9">
              <iframe class="embed-responsive-item" src="" id="video" allowfullscreen allowscriptaccess="always"
                allow="autoplay" autoplay></iframe>
          ...
          <div class="card" height="200px">
            ...
            <div class="card-body">
              ...
              <p class="card-text  custom-truncate" id="truncatableText<?= $i ?>">
                ...
                ipsum dolor, sit amet consectetur adipisicing elit. Placeat voluptates quos in quis accusantium debitis
                at excepturi itaque. Recusandae quos temporibus qui voluptate rerum omnis dolores fugit laudantium
                numquam aspernatur?
              </p>

              <div class="text-center mt-4">
                <a class="" onclick="toggleTruncate(<?= $i ?>)" role="button"><i
                    class="fa fa-chevron-down text-primary fa-lg" id="arrow<?= $i ?>"></i></a>
  ...
  <div id="berita" class="container-fluid py-6">
    <div class="container">
      <div class="text-center wow bounceInUp" data-wow-delay="0.1s">
        ...
        <h1 class="display-5 mb-4">BERITA <span class="text-primary">TERBARU</span></h1>
  ...
  <div id="galeri" class="container-fluid py-6">
    <div class="container">
      ...
      <div class="owl-carousel owl-theme gallery-carousel my-2 wow bounceInUp" data-wow-delay="0.1s">
        <?php
        $i = 1;
        while ($i <= 5) : ?>
